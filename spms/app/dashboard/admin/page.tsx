...
//   const { user, projectGroups, meetings, students, staff, projectTypes } = useAppStore()
...
//                     </div>
//                   </div>
//                   <Progress value={(approvedGroups.length / projectGroups.length) * 100} className="h-2 mt-4" />
//                 </div>
...
//                     {(projectGroups.reduce((acc, g) => acc + g.members.length, 0) / projectGroups.length || 0).toFixed(
//                       1,
//                     )}
//                   </span>
//                 </div>
...
export default function AdminDashboard() {
  ...
  const stats = [
    ...
    {
      title: "Faculty Members",
      value: data.totalStaffs.toString(),
      change: "+2",
      trend: "up",
      icon: UserCog,
      color: "bg-success/10 text-success",
    ...
    {
      title: "Project Types",
      value: data.totalProjectTypes.toString(),
      change: "Active",
      trend: "neutral",
      icon: Settings,
      color: "bg-warning/10 text-warning",
